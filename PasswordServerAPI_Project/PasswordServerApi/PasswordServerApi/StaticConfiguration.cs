...
namespace PasswordServerApi.Service
{
    public static class StaticConfiguration
    {
        ...
        public static readonly ApplicationAction ActionGetAccountAndPassword = new ApplicationAction { Id = ActionGetAccountAndPasswordId, Name = "Αναζήτηση όλων τον λογαριασμών και κωδικών τους", ToolTipText = "Αναζήτηση όλων τον λογαριασμών και κωδικών τους", NeedsComment = false, SendApplicationData = true, Icon = "search", ValidationMode = ApplicationValidationMode.Full, ControllerSend = "Account", ControllerPath = "accounts/accountAction" };
        ...
        public static readonly ApplicationAction ActionGetIfHacked = new ApplicationAction { Id = ActionGetIfHackedId, Name = "Είμαι Ασφαλης?", ToolTipText = "Αναζήτηση κωδικού μου στο WEB", NeedsComment = false, SendApplicationData = true, Icon = "search", ValidationMode = ApplicationValidationMode.Full, ControllerSend = "Account", ControllerPath = "accounts/accountAction" };

        //Password
        public static readonly ApplicationAction ActionGetPasswords = new ApplicationAction { Id = ActionGetPasswordsId, Name = "Αναζήτηση κωδικόν", ToolTipText = "Αναζήτηση κωδικόν", NeedsComment = false, SendApplicationData = false, Icon = "search", ValidationMode = ApplicationValidationMode.Full, ControllerSend = "Password", ControllerPath = "accounts/passwordAction" };
        ...
        //REPORT
        public static readonly ApplicationAction ActionReport = new ApplicationAction { Id = ActionReportId, Name = "Report", ToolTipText = "Report PDF", NeedsComment = false, RefreshAfterAction = false, SendApplicationData = true, Icon = "save", ValidationMode = ApplicationValidationMode.Full, ControllerSend = "Report", ControllerPath = "accounts/exportReport" };
