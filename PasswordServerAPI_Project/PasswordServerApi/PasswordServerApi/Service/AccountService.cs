    ...
    public class AccountService : IAccountService
    {
        ...
        private AccountActionResponse GetIfHackedFunc(AccountDto savedAccount, AccountDto requestedAccount, AccountActionRequest request, string Role)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new AccountActionResponse() { Accounts = GetMyAccount(new BaseRequest() { }, savedAccount.AccountId).Accounts, WarningMessages = new List<string>() { "Service Not Avalable Now" } };
            }
